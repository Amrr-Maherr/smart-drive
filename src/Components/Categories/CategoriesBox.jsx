export default function CategoriesBox({ele}) {
    return (
      <>
        <div className="mx-auto h-[560px]  rounded-3xl flex items-end justify-center py-20 gap-[11px]" style={{ backgroundImage: `url(${ele.image})`,backgroundRepeat:"no-repeat",objectFit:"cover" }}>
